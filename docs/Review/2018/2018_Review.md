...
2019년의 목표를 적어보자. 아직은 1월의 시작하는 첫번째 주니까 너무 늦지 않았다고 생각하기 때문에.. 
이제라도 적어보자.

너무 많은 목표를 잡으면 목표를 잡느니 못한 것이 되어버릴테니 큰 의미의 목표를 두고 천천히 이루어보기로 한다. 

# 영어
인생에 있어서 확실한 것은 아무것도 없지만, 나한테 영어가 가진 의미는 단순히 할 수 있는 언어가 늘어나는 것 그 이상이다.

영어를 읽고 쓰고 말하는데 불편함이 없을 정도가 되면 아마도 내가 가지고 있는 기회의 폭이 엄청나게 넓어질 것이다. 그런 기회를 잡기 위해서라도 나는 영어를 해야 한다.

# 책 50권 읽기 프로젝트
책을 50권 읽고 나만의 방식으로 결과물을 만들어내는 것.
나는 개발자다. 개발자는 꾸준히 공부해야 습득한 지식이 녹슬지 않는다.
작년 한해 동안에도 책을 적게 읽은 것은 아니지만, 올해는 제대로 읽어보고 측정해보기로 했다.
주로 기술 서적을 많이 읽었었고, 소설이나 문학 시집 에세이 등은 거의 읽지 않았었다.
올해는 쉽지 않겠지만 전공서적이나 자기계발서 외에 다른 분야까지 읽을 책의 범위를 넓혀보기로 하자.

여기에 더해서 블로그에 결과물을 적으면 블로그도 활성화 될테니 조금은 나아진 삶을 살 수 있지 않을까..

기대해본다.

새해에는 해돋이도 보고 왔고, 제대로 새해 다짐을 이렇게 기록했다.

내가 기록한 것에 대해서 올해 말에 다시 측정 했을 때 내가 어느정도 이루었을지 알 수는 없지만,
분명한 건 더 나은 삶을 살게 될 것이라는 거다.

또 한번 그 때는 참 열심히 살았었지라고 회상 할 수 있는 한해가 되었으면 좋겠다.
